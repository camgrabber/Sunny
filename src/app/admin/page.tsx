...
// import prisma from '@/lib/db/schema' // Removed: not used and not available
        ...
        <div className="bg-white overflow-hidden shadow rounded-lg">
          <div className="p-5">
            <div className="flex items-center">
              ...
              <div className="ml-5 w-0 flex-1">
                <dl>
                  <dt className="text-sm font-medium text-gray-500 truncate">Cloud Drives</dt>
                  <dd className="text-lg font-medium text-gray-900">{stats.totalDrives}</dd>
                </dl>
              </div>
            </div>
          </div>
            ...
            <div className="flex items-center">
              ...
              <div className="ml-5 w-0 flex-1">
                <dl>
                  ...
                  <dd className="text-lg font-medium text-gray-900">{stats.lastSync}</dd>
                </dl>
              </div>
            </div>
          </div>
